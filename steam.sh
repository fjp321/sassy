echo -e "app-arch/bzip2 abi_x86_32
...
sys-fs/eudev abi_x86_32" > /etc/portage/package.use/steam
eselect repository enable steam-overlay
emerge --sync
emerge -qv --autounmask=y --autounmask-write=y --autounmask-continue=y steam-meta
