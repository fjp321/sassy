...
emerge ${emerge_flags} x11-base/xorg-server x11-drivers/xf86-input-evdev gentoolkit polybar conky neofetch iverilog alacritty gtkwave dev-vcs/git calcurse media-fonts/hack ripgrep dmenu bspwm feh sxhkd i3lock octave dev-python/pip app-eselect/eselect-repository rofi dunst picom cmus gimp alsa jupyter blender neovim
