...
emerge ${emerge_flags} x11-base/xorg-server polybar iverilog kitty gtkwave chromium dev-vcs/git calcurse media-fonts/hack ripgrep dmenu bspwm feh sxhkd dmenu i3lock octave dev-python/pip app-eselect/eselect-repository rofi dunst picom cmus gimp
